...
(function() {
  ...
  function setupCalculator() {
    ...
    // Слушатель разворачивания/сворачивания маршрутного листа станций следования
    var itinToggleBtn = document.getElementById('cr-itinerary-toggle-btn');
    if (itinToggleBtn) {
      itinToggleBtn.addEventListener('click', function(e) {
        e.preventDefault();
